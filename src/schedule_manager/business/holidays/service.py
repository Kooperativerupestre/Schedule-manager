...
from schedule_manager.business.holidays.repository import (
    HolidayConfigBusinessHolidays as HolidayRepositoryContext,
)
...
class BusinessHolidayService:
    ...
    async def add(
        ...
        await CapabilitiesValidator.validate_manage_capability(
            person_id, Resource.BUSINESS_HOLIDAYS, business_id, conn
        )
