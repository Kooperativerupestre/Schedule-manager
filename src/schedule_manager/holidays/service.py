...
class RequestTranslator:
    @staticmethod
    def holiday_datetime_request_to_holiday_datetime(
        request: HolidayDatetimeRequest,
    ) -> HolidayDatetime:
    ...
    @staticmethod
    def holiday_range_request_to_holiday_range(
        request: HolidayRangeRequest,
    ) -> HolidayRange:
        return HolidayRange(
            begin_at=RequestTranslator.holiday_datetime_request_to_holiday_datetime(
                request.begin_at
            ),
            end_at=RequestTranslator.holiday_datetime_request_to_holiday_datetime(
                request.end_at
            ),
        )
    ...
    def add_request_to_holiday(request: HolidayAddRequest) -> Holiday:
        return Holiday(
            ...
            range=RequestTranslator.holiday_range_request_to_holiday_range(
                request.validity_range
            ),
        )

    @staticmethod
    def update_request_to_holiday_changes(
