...
async def update(
    ...
    await WorkstationExceptionService.update(
        person_id, workstation_id, exception_id, request, conn
    )
...
async def delete(
    ...
    await WorkstationExceptionService.delete(
        person_id, workstation_id, exception_id, conn
    )
...
async def get(
    ...
    return await WorkstationExceptionService.get(
        person_id, workstation_id, exception_id, conn
    )
