...
class RequestTranslator:
    @staticmethod
    def add_request_to_workstation(
        ...
        return WorkstationExceptionAddInput(
            ...
            range=ScheduleRequestTranslator.schedule_range_request_to_schedule_range(
                request.range
            ),
        )

    @staticmethod
    def update_request_to_workstation(
        ...
        return WorkstationExceptionChanges(
            ...
            if request.range is not MISSING
            else MISSING,  # type: ignore
        )
