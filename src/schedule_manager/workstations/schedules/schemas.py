...
class ScheduleRequestTranslator:
    @staticmethod
    def schedule_range_request_to_schedule_range(request:ScheduleRangeRequest) -> ScheduleRange:
    ...
    @staticmethod
    def day_schedule_range_request_to_day_schedule(request:DayScheduleRangeRequest) -> DaySchedule:
